    ...
    $.fn.EasyTree = function (options) {
        var defaults = {
            ...
            i18n: {
                ...
                deleteConfirmation: 'Deseja realmente excluir este item？',
        ...
        var createInput = $('<div class="input-group"><input type="text" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-primary confirm"></button> </span><span class="input-group-btn"><button type="button" class="btn btn-warning cancel"></button> </span> </div> ');
