...
public class JobExtratoDemandasSchedule extends AbstractSchedule {
    ...
    public void scheduleInitialTask() {
      ...
      if (TRUE.equals(System.getProperty(Constantes.JOB_EXTRATO_SCHEDULE))) {
    ...
    public void scheduleTask() {
      ...
      String horaAgendamento = parametroDAO.obterParametroByNome(ParametroConstantes.HORARIO_JOB_EXTRATO).getValor();
        ...
        if (Pattern.matches(REGEX_HORARIO, horaAgendamento)) {
          ...
          logger.info("JOB EXTRATO DEMANDAS AGENDADO COM SUCESSO PARA: " + agendamento);
    ...
    public void doWork() {
      ...
      try {
        ...
        if(feriadoService.isDiaUtil(new Date())) {
          SimpleDateFormat sdf =  new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
          String msgInfo = "=================================================\r\n";
          msgInfo += "Início da Rotina de Extrato - " + sdf.format(new Date()) + "\r\n";
          logger.info(msgInfo);
          
          rotinaEmailService.enviarEmailExtratoDemandas();    
          
          msgInfo = "";
          msgInfo += "Fim da Rotina de Extrato - " + sdf.format(new Date()) + "\r\n";
          msgInfo += "=================================================\r\n";
          logger.info(msgInfo);
        }
