...
public abstract class AbstractService<T> implements BaseService<T> {
   ...
   *           Exception Gerada
   */
  protected List<T> updateLote(Collection<T> listEntity) throws RequiredException, BusinessException, DataBaseException {
   ...
   *           Exception Gerada
   */
  public T save(T entity) throws RequiredException, BusinessException, DataBaseException {
   ...
   *           Exception Gerada
   */
  protected T saveImpl(T entity) throws RequiredException, BusinessException, DataBaseException {
    try {
   ...
   *           Exception Gerada
   */
  public T update(T entity) throws RequiredException, BusinessException, DataBaseException {
   ...
   *           Exception Gerada
   */
  public List<T> update(Collection<T> listEntity) throws RequiredException, BusinessException, DataBaseException {
   ...
   *           Exception Gerada
   */
  protected T updateImpl(T entity) throws RequiredException, BusinessException, DataBaseException {
    try {
   ...
   * @throws DataBaseException 
   */
  public void remove(T entity) throws BusinessException, DataBaseException {
   ...
   *           Exception Gerada
   */
  protected void removeImpl(T entity) throws BusinessException, DataBaseException {
    try {
