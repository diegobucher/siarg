...
public class AjaxListener implements PhaseListener {
  ...
  public void beforePhase(PhaseEvent evento) {
    ...
    if (ajaxRequest) {
      OmniPartialViewContext requestContext =
          (OmniPartialViewContext) FacesContext.getCurrentInstance().getAttributes().get(OMNI_PARTIAL_VIEW_CONTEXT);
