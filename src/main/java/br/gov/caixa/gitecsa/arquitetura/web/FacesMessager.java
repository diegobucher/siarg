package br.gov.caixa.gitecsa.arquitetura.web;
...
/**
 * Classe utilitaria para gerencimento de mensagens do JSF.
 * 
 */
@RequestScoped
public class FacesMessager {
  ...
  public void info(String message) {
    FacesContext.getCurrentInstance().addMessage(message, new FacesMessage(FacesMessage.SEVERITY_INFO, message, null));
  }
  ...
  public void error(String message) {
    FacesContext.getCurrentInstance().addMessage(message, new FacesMessage(FacesMessage.SEVERITY_ERROR, message, null));
  }
  ...
  public void warn(String message) {
    FacesContext.getCurrentInstance().addMessage(message, new FacesMessage(FacesMessage.SEVERITY_WARN, message, null));
  }
  ...
  private void addMensagemDistinct(String msg, FacesMessage facesMessage) {
    ...
    for (Iterator iterator = FacesContext.getCurrentInstance().getMessages(); iterator.hasNext();) {
