...
/**
 * Classe que concentra o fluxo de uma tela de consulta que pode redirecionar para cadastro,edição. Sendo possível
 * excluir e filtrar.
 * @author wfjesus
 */
public abstract class ConsultarBaseController<T> extends BaseController {
  ...
  /**
   * Redireciona para a tela de manter do CRUD.
   * @return String
   */
  ...
  /**
   * Grava a Instância utilizada para filtrar a consulta.
   * @param instanceFilter **Instância**
   */
  ...
  /**
   * Grava a Instância do CRUD.
   * @param instanceCRUD **Instância**
   */
