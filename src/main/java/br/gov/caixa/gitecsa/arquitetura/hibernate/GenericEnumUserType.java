...
public class GenericEnumUserType implements UserType, ParameterizedType {
  ...
  private static final String DEFAULT_GET_VALUE_METHOD_NAME = "getValor";
  ...
  public void setParameterValues(Properties properties) {
    ...
    type = (AbstractSingleColumnStandardBasicType<Object>) tr.basic(valueType.getName());
    if (type == null) {
  ...
  @Override
  public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor owner, Object arg3)
  ...
  @Override
  public void nullSafeSet(PreparedStatement st, Object value, int index, SessionImplementor owner)
      throws HibernateException, SQLException {
    try {
      if (value == null) {
        ...
        if (value.getClass().equals(enumClass)) {
          ...
          identifier =
              getValueMethod.invoke(
                  valueOfMethod.invoke(enumClass.getEnumConstants()[0], Integer.parseInt(String.valueOf(value))), new Object[0]);
        }
        type.set(st, identifier, index, owner);
      }
    } catch (Exception e) {
      throw new HibernateException(
          "Exception while invoking identifierMethod '" + getValueMethod.getName() + "' of enumeration class '" + enumClass + "'",
          e);
    }
  }
